...
class CalcCtrl { //wiadomości dla widoku
	...
	public function validate() {
		...
		if(!inRole('admin') && $this->form->loan_am > 10000){
			getMessages()->addError("Niestety nie jesteś adminem, więc kwota kredytu nie może wynosić więcej, niż 10 000zł");
		}
	...
	public function action_showView(){
